    ...
    return (
      <Html>
        <Head>
          ...
          <meta
            name="description"
            content="Profitez d'une soirée dans un Privates Cafe. Un café privé privé pour l'autre moitié, des amis ou des collègues - les salles peuvent accueillir jusqu'à 25 personnes. Dans le café privé, vous pouvez chanter au karaoké, jouer à des jeux de société, jouer à un décodeur."
          />
          <link
