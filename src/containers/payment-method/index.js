  ...
  return (
    <Container>
      <Main>
        ...
        <Desk>
          Au moment de la réservation, 1 euro est réservé sur votre compte. Le montant restant sera payé au
          moment de votre visite chez nous. Vous pouvez annuler votre réservation à tout moment sans que des
          frais ne vous soient facturés.
        </Desk>
        <div style={{ marginTop: '25px' }}>
          <Dropdown isOpen={d2} onClick={handleOpenD2}>
            <div className="left">
              <Img src="bank.png" />
              <DTitle>Compte bancaire</DTitle>
            </div>
            <div className="right">
          ...
          <BbrBodyBank isOpen={d2}>
            <div>
              <div style={{ paddingLeft: 48, marginBottom: -24 }}>
                <LOADER />
                <strong>Banques disponibles</strong>
              </div>
              <BankCont>
                <P_N26>
              ...
              <div style={{ paddingLeft: 48, marginBottom: 24, marginTop: -24 }}>
                <strong>Vous n'avez pas trouvé votre banque ? Payez par carte.</strong>
              </div>
              ...
              >
                <div style={{ paddingLeft: 48 }}>
                  <Box>
                    ...
                    <span style={{ color: 'rgba(0, 0, 0, 0.87)' }}>Carte de crédit</span>
                  </Box>
                </div>
              </a>
            </div>
